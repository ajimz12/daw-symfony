 ...
 */
final class Version20250116191607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD winner_id INT DEFAULT NULL, CHANGE result result VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game DROP winner_id, CHANGE result result VARCHAR(255) DEFAULT NULL');
    }
}
